...
class Raiz(instruccion):
    ...
    def interpretar(self, tree, table):
                ...
                if ( self.expresion.tipo == tipo.DECIMAL ) or ( self.expresion.tipo == tipo.ENTERO ):
                    ...
                    return self.raizCuadrada(self.obtenerVal(self.expresion.tipo,val)  )

            
                return Excepcion("Semantico","Tipo valor erroneo para sqrt(valor)",self.fila,self.columna)




    def raizCuadrada(self,expresion):#METODO PARA SACAR raiz cuadrada
        #en py 1ero es num 
