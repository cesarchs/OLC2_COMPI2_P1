...
class Tangente(instruccion):
    ...
    def interpretar(self, tree, table):
                ...
                if ( self.expresion.tipo == tipo.DECIMAL ) or ( self.expresion.tipo == tipo.ENTERO ):
                    ...
                    return self.Tangente(self.obtenerVal(self.expresion.tipo,val)  )

            
                return Excepcion("Semantico","Tipo valor erroneo para tan(valor)",self.fila,self.columna)




    def Tangente(self,expresion):#METODO PARA SACAR tangente
        #en py 1ero es num 
        
        return math.tan(math.radians(expresion))
