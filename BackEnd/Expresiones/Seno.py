...
class Seno(instruccion):
    ...
    def interpretar(self, tree, table):
                ...
                if ( self.expresion.tipo == tipo.DECIMAL ) or ( self.expresion.tipo == tipo.ENTERO ):
                    ...
                    return self.Seno(self.obtenerVal(self.expresion.tipo,val)  )

            
                return Excepcion("Semantico","Tipo valor erroneo para sin(valor)",self.fila,self.columna)




    def Seno(self,expresion):#METODO PARA SACAR seno
        #en py 1ero es num 
        
        return math.sin(math.radians(expresion))
