...
def p_modular(t):#falta para temp
    '''
    MODULAR : MATH POINT MOD LEPAR finalExp COMMA finalExp RIPAR
    
    '''
    t[0]=MathFunc(t[5],t[7], t.lineno(2), t.lexpos(2))
...
def parseOP(input2):
    ...
    global input
    input = input2
    return parser2.parse(input2, lexer=lexer1)


'''
out=" NO CORRIO BIEN LA OPTIMIZACION :/"
f = open("./salida2.txt","r")
entrada = f.read()
#print("--------------------------------------INICIO ANALIZADOR 2----------------------------------")
